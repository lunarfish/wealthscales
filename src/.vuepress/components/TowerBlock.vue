    ...
    <v-card class="my-5">
        ...
        <v-card-text>
            ...
            <v-row class="mt-5">
                ...
                <v-col :cols="6" :style="{textAlign:'center'}"><span class="text-h2">100 households<br/>(Roughly 2,500 people)</span></v-col>
                <v-col :cols="6"><households icon="mdi-office-building" :size="150" :width="1" :height="1"/></v-col>
